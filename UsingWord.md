...
For starters, here’s a link to the PDF of Microsoft’s downloadable [Quick Start Guide For Word](http://download.microsoft.com/download/1/2/6/1269C192-F79E-4918-B737-D828E0522349/Word%20QS.pdf), which give the "official" intro to the program. It might be a useful complement to the info I've provided here (which is wordier, but deeper).
...
###### Note 1:  I’ve never used Word on a Mac, so I have no insight into how applicable this guide is for Mac users.
